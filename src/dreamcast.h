...
/* Allow cache sizes to be overridden via env at startup if desired; keep defaults */
#define XLAT_NEW_CACHE_SIZE 64 MB
#define XLAT_TEMP_CACHE_SIZE 4 MB
#define XLAT_OLD_CACHE_SIZE 16 MB
