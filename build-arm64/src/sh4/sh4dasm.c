...
#line 199 "../../src/sh4/sh4dasm.in"
                    ...
                    case 0x8:
                        switch( (ir&0xFF0) >> 4 ) {
                            case 0x0:
                                { /* CLRT */
#line 74 "../../src/sh4/sh4dasm.in"
                                snprintf( buf, len, "CLRT    " );
                                }
                                break;
                            case 0x1:
                                { /* SETT */
#line 220 "../../src/sh4/sh4dasm.in"
                                snprintf( buf, len, "SETT    " );
                                }
                                break;
                            case 0x2:
                                { /* CLRMAC */
#line 72 "../../src/sh4/sh4dasm.in"
                                snprintf( buf, len, "CLRMAC  " );
                                }
                                break;
                            case 0x3:
                                { /* LDTLB */
#line 153 "../../src/sh4/sh4dasm.in"
                                snprintf( buf, len, "LDTLB   " );
                                }
                                break;
                            case 0x4:
                                { /* CLRS */
#line 73 "../../src/sh4/sh4dasm.in"
                                snprintf( buf, len, "CLRS    " );
                                }
                                break;
                            case 0x5:
                                { /* SETS */
#line 219 "../../src/sh4/sh4dasm.in"
                    ...
                    case 0x9:
                        switch( (ir&0xF0) >> 4 ) {
                            case 0x0:
                                { /* NOP */
#line 204 "../../src/sh4/sh4dasm.in"
                                snprintf( buf, len, "NOP     " );
                                }
                                break;
                            case 0x1:
                                { /* DIV0U */
#line 85 "../../src/sh4/sh4dasm.in"
...
#line 240 "../../src/sh4/sh4dasm.in"
                    ...
                    case 0xB:
                        switch( (ir&0xFF0) >> 4 ) {
                            case 0x0:
                                { /* RTS */
#line 218 "../../src/sh4/sh4dasm.in"
                                snprintf( buf, len, "RTS     " );
                                }
                                break;
                            case 0x1:
                                { /* SLEEP */
#line 233 "../../src/sh4/sh4dasm.in"
                                snprintf( buf, len, "SLEEP   " );
                                }
                                break;
                            case 0x2:
                                { /* RTE */
#line 217 "../../src/sh4/sh4dasm.in"
...
#line 96 "../../src/sh4/sh4dasm.in"
                    ...
                    case 0x5:
                        { /* FCMP/GT FRm, FRn */
                        uint32_t FRn = ((ir>>8)&0xF); uint32_t FRm = ((ir>>4)&0xF); 
#line 97 "../../src/sh4/sh4dasm.in"
                        snprintf( buf, len, "FCMP/GT FR%d, FR%d", FRm, FRn );
                        }
                        break;
                    case 0x6:
                        { /* FMOV @(R0, Rm), FRn */
                        uint32_t FRn = ((ir>>8)&0xF); uint32_t Rm = ((ir>>4)&0xF); 
#line 113 "../../src/sh4/sh4dasm.in"
...
#line 124 "../../src/sh4/sh4dasm.in"
                                            ...
                                            case 0x1:
                                                switch( (ir&0xC00) >> 10 ) {
                                                    case 0x0:
                                                        { /* FSCHG */
#line 118 "../../src/sh4/sh4dasm.in"
                                                        snprintf( buf, len, "FSCHG   " );
                                                        }
                                                        break;
                                                    case 0x2:
                                                        { /* FRCHG */
#line 116 "../../src/sh4/sh4dasm.in"
                                                        snprintf( buf, len, "FRCHG   " );
                                                        }
                                                        break;
                                                    case 0x3:
                                                        { /* UNDEF */
#line 274 "../../src/sh4/sh4dasm.in"
